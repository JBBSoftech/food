...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/food_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '690dbba04f9e50be40308899',
      shopName: 'Food',
...
app.listen(PORT, () => {
  console.log(`Food Backend Server running on port ${PORT}`);
});
